      ...
      <section class="mt-2">
        <div class="ui-dashboard-card">
          ...
          <div class="ui-dashboard-card-body">
            <form class="frm--cstm pt-2">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="fs-14  brand-dblue">Message Title</label
                    ><input
                      type="text"
                      class="form-control "
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="fs-14  brand-dblue">Message Type</label
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="fs-14  brand-dblue">Recipient</label
                        ><select class="form-control  custom-select"
                          ><option value="">Select recipient</option
                          ><option value="donors">Donors</option></select
                        >
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label class="fs-14  brand-dblue">Message</label
                    ><textarea
                      class="form-control "
...
export default {
  ...
  computed: mapGetters(["getloading", "getClinicProfile"]),
  props: {
    menuIcons: {
      type: Boolean,
      required: true,
